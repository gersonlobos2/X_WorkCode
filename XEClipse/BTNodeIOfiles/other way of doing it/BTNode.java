...
public class BTNode<E>
{
   ...
   **/
   public void postorderPrint( )
   {
      ...
      System.out.print(data); // i changed println to a print
   }   
   ...
   **/
   ...
   public void print2(int depth)
   {
	   if(right != null){
		   right.print2(depth+7);
	   }
   ...
   **/ 
   ...
   public static <E> int TreeHeight(BTNode<E> root)   // to calculate the height
   {
	   if(root==null)
		   return -1;
	   else{
