...
// =========================================================================
 ...
 Precondition: a node pointer has to be passed
 Postcondition: it will display the whole linked list
 
// =========================================================================
 Node* findLink(Node* find,int at);
 Precondition: a pointer and an integer that refers to the position of the 
 card in the list has to be passed.
 Postcondition:it will return the address of the card possition that was passed
// =========================================================================
 Node* setNodeDeck();
 Precondition: none
 Postcondition: it will create the linked list and set the deck to its values.
// =========================================================================
 Node* GenerateNodeCards(Node * headPtr,int size);
 Precondition: a node pointer pointing to the header and an integer that 
 represents the lenght of the new linked list have to be passed
 Postcondition: it will return a pointer to a new linked list with random picked cards
// =========================================================================
