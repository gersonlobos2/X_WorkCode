...
namespace GelaTree
{
    ...
    public:
		...
		void insertOne(binary_tree_node<Item>* NewOne){
			recursiveAdd(RootPtr);
		 }
	...
	//****************** inserting
	//template <class Item,class Ptr >
	//void treeinsert(Item key,  Ptr leaf);
	
	//printing in the different order.
	template <class Item>
	void inOrderPrint(const binary_tree_node<Item>* );
	
	template <class Item>
	void preOrderPrint(const binary_tree_node<Item>* );
	
	template <class Item>
	void postOrderPrint(const binary_tree_node<Item>* );
